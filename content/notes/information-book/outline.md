...
Two foundational questions shape the final form of the thesis — one still open, one now worked through:
...
Three foundational notes are also drafted — [[transport-vs-selection]], [[medium-and-manipulation]], and [[three-layer-message]] — working out structural questions the chapters depend on.
